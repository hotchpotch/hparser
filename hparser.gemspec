Gem::Specification.new do |s|
  ...
  s.summary = %q{}
  s.test_files = ["test/test_inline_html.rb", "test/test_dl.rb", "test/test_id.rb", "test/test_tags.rb", "test/test_text.rb", "test/test_block.rb", "test/test_hatena.rb", "test/test_head.rb", "test/test_table.rb", "test/test_pair.rb", "test/test_url.rb", "test/test_inline.rb", "test/test_html.rb", "test/test_helper.rb", "test/test_p.rb"]
end
